...
# Pipeline utilities live in this skill's own scripts/lib/ (canonical home;
# article-to-video imports it via a re-export shim). Add scripts/ to sys.path
# so `from lib.utils import ...` resolves to the local package.
