...
version: "1.4.2"
description: 把一篇已有文章（Markdown/纯文本）改写成**单人专业资讯播客**——像《晚点》《硅谷 101》的资讯简报，客观陈述为主、信息密度高、关键处给一句精炼"点评："判断。输出脚本 + TTS 音频 + 标题描述。改写导向（书面文章→专业资讯主理人播报口吻），内置 10 维 rubric（清晰度/节奏/保真，不奖励闲聊腔）+ 评价→修正迭代循环，迭代到市场可用（每维≥4、零虚构）。MiMo voiceclone 单次合成单音色音频（不拆段，音色最一致），可接喜马拉雅发布（需确认）。**触发场景**：用户提到"文章转单人播客""单人播客""专业资讯播报""资讯简报""新闻播报体""独白播客""文章做播客""把文章变成播客音频""文章转喜马拉雅播客""solo podcast""文字转播客音频"，或想把一篇现成文章/笔记/博客生成单人资讯播客时使用。本 skill 的输入是**文章/文本**（改写导向），不是录音/音频。
metadata:
  platforms: [boker]
---
...
把一篇**已有文章**改写成一段**市场可用的单人专业资讯播客**。心智模型是**一位专业资讯主理人做当日 AI 资讯简报**（像《晚点》《硅谷 101》资讯速递）——客观陈述为主、信息密度高、每条结论先行、关键处给一句精炼"点评："判断。改写导向（书面文章→专业资讯播报口吻），不是转录清洗，也不是朋友闲聊。
...
**内容生成（改写导向）**
3. **心智模型**：把书面文章改写成"专业资讯主理人做资讯简报"的播报——客观陈述为主、信息密度高、关键处给克制点评。不是朋友闲聊，不是净化口语转录。
...
2. `播客_TTS.mp3` 存在、时长 6-10 分钟、单音色一致、专业资讯腔调（客观陈述为主 + 克制点评）。
