...
复用（只读，不修改）：
  ...
  - whisper-transcribe/scripts/lib/utils.py（经本 skill scripts/lib/utils.py 的 re-export shim 转发，跨 skill 单一权威源）
...
# utils 经本地 lib/utils.py 的 re-export shim 指向 whisper-transcribe 的单一权威源
