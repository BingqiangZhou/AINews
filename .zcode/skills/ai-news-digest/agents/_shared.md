...
- **PROJECT_ROOT**：`E:\Projects\AI\AINews`（仓库根）
- **SKILL_ROOT**：`{PROJECT_ROOT}\.zcode\skills\ai-news-digest`
- **A2S_ROOT**：`{PROJECT_ROOT}\.zcode\skills\audio-to-social`（复用资产来源）
- **SCRIPTS_DIR**：`{SKILL_ROOT}\scripts`
- **A2S_SCRIPTS**：`{A2S_ROOT}\scripts`
- **OUTPUT_DIR**：`{storage_root}\articles\{YYYY-MM-DD}_AI日报\`（storage_root 从 config.brand 读）
